...
*/
var myarray = [10, 'Alvaro', null, {a: 1}, function() {}];
...
*/
var myarray2 = ['Ninja', 52.4, true, [ 1, 2, 'Alvaro'], { b:2 }];
...
function book( bookName ){
    ...
    //bookname nao foi passado? entao eu retorno allbooks
...
*/
console.log(' O livro ' + bookName + ' foi publicado pela editadora ' + book( bookName ).editora + '.' );